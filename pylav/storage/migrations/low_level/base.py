...
from pylav.storage.migrations.low_level.v_1_15_7 import low_level_v_1_15_7_migration
from pylav.storage.migrations.low_level.v_1_15_14 import low_level_v_1_15_14_migration
...
async def run_low_level_migrations(migrator: ConfigController) -> dict[str, dict[str, list[asyncpg.Record] | None]]:
    ...
    await low_level_v_1_15_7_migration(con)
    await low_level_v_1_15_14_migration(con)
